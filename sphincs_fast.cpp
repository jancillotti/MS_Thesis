...
static int sign_and_verify_sphincs_fast() {
    ...
    auto priv_key = Botan::SphincsPlus_PrivateKey(rng, Botan::Sphincs_Parameter_Set::Sphincs128Fast, Botan::Sphincs_Hash_Type::Sha256);
